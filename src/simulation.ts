...
function simulateCreditNoAmort(inDebt: number, months: number, interestRate: number, encargos: number, monthsToCalc: number, startingMonth: number): NoAmortSimulationResult {
...
function simulateCreditWithAmort(inDebt: number, months: number, interestRate: number, encargos: number,
    amortValue: number, amortPeriod: number, amortComission: number, minMonthly: number, monthsToCalc: number, startingMonth: number): AmortSimulationResult {
    let year = Math.floor(startingMonth / 12) + 1
